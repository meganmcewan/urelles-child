					...
					<?php if($blog_hide_author == "no") { ?>
						<div class="post_author_holder">
							<div class="post_author">
								<span><?php _e('Par', 'urelles'); ?></span> <a class="post_author_link" href="<?php echo get_author_posts_url( get_the_author_meta( 'ID' ) ); ?>"><span><?php the_author_meta('display_name'); ?></span></a>
							</div>
						</div>
					<?php } ?>
				</div>
